...
export const adminDashboardCopy = {
  en: {
    ...
    stats: [
      { label: "Total Bakeries", hint: "All registered bakery tenants" },
      { label: "Total Orders", hint: "Orders across all bakeries" },
      { label: "Pending Orders", hint: "Orders waiting for completion" },
      { label: "Total Products", hint: "Platform-wide product records" },
      { label: "Total Customers", hint: "Customer records in all bakeries" },
      { label: "Total Owners", hint: "Users with OWNER role" },
    ],
    bakeries: {
      title: "Bakeries List",
  ...
  am: {
    ...
    stats: [
      { label: "ጠቅላላ ቤኬሪዎች", hint: "የተመዘገቡ ሁሉም ቤኬሪዎች" },
      { label: "ጠቅላላ ትዕዛዞች", hint: "በሁሉም ቤኬሪዎች ያሉ ትዕዛዞች" },
      { label: "በመጠባበቅ ያሉ ትዕዛዞች", hint: "ማጠናቀቅ የሚጠብቁ ትዕዛዞች" },
      { label: "ጠቅላላ ምርቶች", hint: "በፕላትፎርሙ ላይ ያሉ የምርት መዝገቦች" },
      { label: "ጠቅላላ ደንበኞች", hint: "በሁሉም ቤኬሪዎች ያሉ የደንበኛ መዝገቦች" },
      { label: "ጠቅላላ ባለቤቶች", hint: "OWNER ሚና ያላቸው ተጠቃሚዎች" },
    ],
    bakeries: {
      title: "የቤኬሪዎች ዝርዝር",
